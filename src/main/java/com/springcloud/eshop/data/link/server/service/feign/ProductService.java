package com.springcloud.eshop.data.link.server.service.feign;
...
public interface ProductService {
    ...
    ServerResponse findProductPropertyByProductId(@RequestParam("productId") String productId);

    @GetMapping("/product-specification/findByProductId")
    ServerResponse findProductSpecificationByProductId(@RequestParam("productId") String productId);
